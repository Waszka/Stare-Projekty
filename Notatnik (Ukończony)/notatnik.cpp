        ...
        if (OpenDialog1->Execute())
          {
                ...
                {
                        ShowMessage("B³¹d otwarcia pliku. SprawdŸ czy plik istnieje na dysku.");
                }
...
void __fastcall TForm1::Nowy1Click(TObject *Sender)
{
        ...
        "Czy napewno utworzyæ nowy plik?","PotwierdŸ",
...
{
        ShellExecute(NULL,"open","http://www.g2.swidnica.pl/", NULL, NULL,
        SW_SHOWNORMAL);
}
//---------------------------------------------------------------------------
